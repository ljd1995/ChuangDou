 ...
 * 描述：
 */
public  class BookCultureController extends BaseBookDataController  {

    public BookCultureController(Context context, View view, RecyclerView recyclerView, View pageLoading, View pageError, ViewGroup container) {
