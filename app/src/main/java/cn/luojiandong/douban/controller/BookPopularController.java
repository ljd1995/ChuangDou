 ...
 * 描述：
 */
public  class BookPopularController extends BaseBookDataController  {

    public BookPopularController(Context context, View view, RecyclerView recyclerView, View pageLoading, View pageError, ViewGroup container) {
