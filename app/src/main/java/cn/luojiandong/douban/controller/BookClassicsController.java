 ...
 * 描述：
 */
public  class BookClassicsController extends BaseBookDataController  {
    public BookClassicsController(Context context, View view, RecyclerView recyclerView, View pageLoading, View pageError, ViewGroup container) {
