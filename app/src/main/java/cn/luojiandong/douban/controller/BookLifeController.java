 ...
 * 描述：
 */
public  class BookLifeController extends BaseBookDataController  {

    public BookLifeController(Context context, View view, RecyclerView recyclerView, View pageLoading, View pageError, ViewGroup container) {
