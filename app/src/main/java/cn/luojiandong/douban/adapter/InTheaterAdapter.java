...
public class InTheaterAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private List<SubjectsInfo> mDatas;
    private LayoutInflater mInflater;
    private InTheaterAdapter.OnItemClickListener mOnItemClickListener;
    ...
    public void setOnItemClickListener(InTheaterAdapter.OnItemClickListener onItemClickListener) {
        mOnItemClickListener = onItemClickListener;
    }

    public InTheaterAdapter(List<SubjectsInfo> datas) {
        mDatas = datas;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new InTheaterAdapter.InTheaterViewHolder(mInflater.inflate(R.layout.item_intheaters_list, parent, false));
    }

    @Override
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        InTheaterAdapter.InTheaterViewHolder movieViewHolder = (InTheaterAdapter.InTheaterViewHolder) holder;
